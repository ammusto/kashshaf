...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // The workspace, the table of contents and notes (spec 1.5 A, B2, C4)
            commands::workspace::workspace_list,
            commands::workspace::workspace_add,
            commands::workspace::workspace_remove,
            commands::workspace::workspace_open,
            commands::workspace::workspace_export,
            commands::workspace::workspace_save_state,
            commands::workspace::workspace_open_folder,
            commands::workspace::get_toc,
            commands::workspace::get_toc_rows,
            commands::workspace::toc_section_range,
            commands::workspace::notes_list,
            commands::workspace::note_save,
            commands::workspace::note_update,
            commands::workspace::note_delete,
            ...
            commands::books::list_authors,
            commands::books::list_genres,
